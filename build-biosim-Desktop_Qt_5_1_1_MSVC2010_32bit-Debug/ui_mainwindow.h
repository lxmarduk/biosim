...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuBar->setGeometry(QRect(0, 0, 502, 19));
        ...
        menuBiosim->addAction(actionAbout_Biosim);
        menuBiosim->addAction(actionExit);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionAbout_Biosim->setText(QApplication::translate("MainWindow", "About Biosim", 0));
